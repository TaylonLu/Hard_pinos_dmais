module elm_fsm (
	...
	reg  done;
	reg  [7:0]  hid_wr_addr;
		reg   [15:0] hid_wr_data;
     reg         hid_wr_en;

     reg  [7:0]  hid_rd_addr;
      wire  [15:0] hid_rd_data;

     reg  [3:0]  out_wr_addr;
     reg   [15:0] out_wr_data;
     reg         out_wr_en;
    ...
    assign sig_in = mac_saida_reg;
	 ...
	 assign rst_n = !neg_rst;
	 assign start = !neg_start;
